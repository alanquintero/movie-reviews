...
<div>
    ...
    <form:form commandName="appUser" cssClass="form-horizontal settingsForm">
        ...
        <div class="form-group">
            ...
            <p>${appUser.email}</p>
            <form:input path="email" type="hidden" value="${appUser.email}" />
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" userName="password_again" id="password_again" class="form-control" maxlength="30" />
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-4 col-md-offset-4">
                <button id="singlebutton" class="btn btn-primary center-block">Save</button>
            </div>
        </div>
