...
<html>
    ...
    <head>
        ...
        <title>
            <tiles:getAsString userName="title"></tiles:getAsString>
        </title>
    ...
    <body>
    	...
    	<tilesx:useAttribute userName="current" />
    	...
    	<div class="container">
				    ...
				    <div id="navbar" class="navbar-collapse collapse">
					    ...
					    <ul class="nav navbar-nav">
						    <li class="${current == 'result' ? 'active' : ''}">
						        <a id="searchLink" href="<spring:url value="/result.html" />">
						            Search
						        </a>
						    </li>
						    <security:authorize access="isAuthenticated() and hasRole('ROLE_ADMIN')">
							    <li class="${current == 'appUsers' ? 'active' : ''}">
							        <a href="<spring:url value="/appUsers.html" />">
							            Users
							        </a>
							    </li>
						    </security:authorize>
						    <security:authorize access="isAuthenticated() and hasRole('ROLE_ADMIN')">
							    <li class="${current == 'movies' ? 'active' : ''}">
							        <a href="<spring:url value="/movies.html" />">
							            Movies
							        </a>
							    </li>
						    </security:authorize>
						    <security:authorize access="isAuthenticated()">
							    <li class="${current == 'profile' ? 'active' : ''}">
							        <a href="<spring:url value="/profile.html" />">
							            My Profile
							        </a>
							    </li>
						    </security:authorize>
		    ...
		    <tiles:insertAttribute userName="body" />

		    <br><br>

		    <p style="text-align: center">
			    <tiles:insertAttribute userName="footer" />
		    </p>
